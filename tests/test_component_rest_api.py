...
from micro_registry.component import (
    MicroComponent,  # Importing MicroComponent from component.py
)
...
class TestComponentRestApi(unittest.TestCase):
    ...
    def test_02_create_child_component(self):
        ...
        self.assertEqual(
            instance_registry["ChildComponent1"].parent.name, "RootComponent"
        )
    ...
    def test_03_create_grandchild_component(self):
        ...
        self.assertEqual(
            instance_registry["GrandChildComponent"].parent.name, "ChildComponent1"
        )
            ...
            "children": [
                {
                    ...
                    "children": [{"name": "GrandChildComponent", "children": []}],
                }
            ],
        }
    ...
    def test_05_get_component_attributes(self):
        ...
        response = self.client.get(
            self.prefix + "/component/RootComponent/ChildComponent1/attributes/"
        )
        self.assertEqual(response.status_code, 200)
        ...
        expected_attributes = {
            ...
            "children": {
                "items": [
                    {"type": "MicroComponent", "component_name": "GrandChildComponent"}
                ],
                "type": "list",
            },
        }
    ...
    def test_06_get_all_component_information(self):
        ...
        response = self.client.get(
            self.prefix + "/component/RootComponent/ChildComponent1/all/"
        )
        self.assertEqual(response.status_code, 200)
            ...
            "attributes": {
                ...
                "children": {
                    "items": [
                        {
                            "type": "MicroComponent",
                            "component_name": "GrandChildComponent",
                        }
                    ],
                    "type": "list",
                },
    ...
    def test_07_prepare_component(self):
        ...
        with patch("builtins.print") as mocked_print:
            response = self.client.post(
                self.prefix + "/component/RootComponent/ChildComponent1/prepare/"
            )
            self.assertEqual(response.status_code, 200)
