...
class TestComponentRestApi(unittest.TestCase):
    ...
    def test_create_grandchild_component(self):
    ...
    def test_get_component_hierarchy(self):
    ...
    def test_get_component_attributes(self):
        ...
        self.assertEqual(response.json()["attributes"], expected_attributes)

    def test_get_all_component_information(self):
        ...
        self.assertEqual(response.json(), expected_all_info)
    ...
    def test_create_component_non_existent_parent(self):
...
def suite():
    ...
    suite.addTest(TestComponentRestApi("test_create_root_component"))
    suite.addTest(TestComponentRestApi("test_create_child_component"))
    suite.addTest(TestComponentRestApi("test_create_grandchild_component"))
    suite.addTest(TestComponentRestApi("test_get_component_hierarchy"))
    suite.addTest(TestComponentRestApi("test_get_component_attributes"))
    suite.addTest(TestComponentRestApi("test_get_all_component_information"))
    suite.addTest(TestComponentRestApi("test_prepare_component"))
    suite.addTest(TestComponentRestApi("test_start_component"))
    suite.addTest(TestComponentRestApi("test_pause_component"))
    suite.addTest(TestComponentRestApi("test_stop_component"))
    suite.addTest(TestComponentRestApi("test_create_component_non_existent_parent"))
    return suite
