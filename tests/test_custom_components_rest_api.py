...
class TestComponentTree(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.api = ComponentRestApi(
            name="ComponentRestApiExtension", parent=cls.registry_server
        )
    ...
    def test_04_get_controller_hierarchy(self):
        ...
        expected_hierarchy = {
            "name": "MainController",
            "children": [
                {"name": "TemperatureSensor", "children": []},
                {"name": "CoolingFan", "children": []},
            ],
        }
    ...
    def test_05_read_sensor_property(self):
        ...
        response = self.client.get(
            self.prefix + "/component/MainController/TemperatureSensor/attributes/"
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_06_read_actuator_property(self):
        ...
        response = self.client.get(
            self.prefix + "/component/MainController/CoolingFan/attributes/"
        )
        self.assertEqual(response.status_code, 200)
        attributes = response.json()["attributes"]
    ...
    def test_07_update_sensor_property(self):
        ...
        response = self.client.post(
            self.prefix
            + "/component/MainController/TemperatureSensor/update-property/",
            json={"property_name": "reading", "value": 30.0},
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_08_update_actuator_property(self):
        ...
        response = self.client.post(
            self.prefix + "/component/MainController/CoolingFan/update-property/",
            json={"property_name": "state", "value": True},
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_09_update_controller_property(self):
        ...
        response = self.client.post(
            self.prefix + "/component/MainController/update-property/",
            json={"property_name": "setpoint", "value": 80.0},
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_10_invalid_sensor_reading(self):
        ...
        response = self.client.post(
            self.prefix
            + "/component/MainController/TemperatureSensor/update-property/",
            json={"property_name": "reading", "value": -10.0},
        )
    ...
    def test_11_update_nonexistent_property(self):
        ...
        response = self.client.post(
            self.prefix
            + "/component/MainController/TemperatureSensor/update-property/",
            json={"property_name": "nonexistent_property", "value": 100},
        )
    ...
    def test_12_update_all_component_attributes(self):
        ...
        response = self.client.post(
            self.prefix
            + "/component/MainController/TemperatureSensor/update-attributes/",
            json={
                "attributes": {
                    "reading": 28.5,
    ...
    def test_13_update_all_component_attributes_with_errors(self):
        ...
        self.assertIn(
            "Value must be non-negative", response.json()["detail"][0]["reading"]
        )
...
def suite():
    ...
    suite.addTest(
        TestComponentTree("test_13_update_all_component_attributes_with_errors")
    )
    return suite
