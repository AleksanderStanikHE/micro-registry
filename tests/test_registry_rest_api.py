...
class TestRestApi(unittest.TestCase):
    ...
    def test_list_registered_instances(self):
        ...
        response = self.client.post("/create-instance/", json={
    ...
    def test_get_instance_attributes(self):
        ...
        self.client.post("/create-instance/", json={
            "class_name": "TestComponent",
            "instance_name": "attribute_instance",
            "parameters": {"name": "AttributeInstance", "value": 99}
        })

        response = self.client.get("/instance/attribute_instance/attributes/")
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_instance_attribute(self):
        ...
        self.client.post("/create-instance/", json={
            "class_name": "TestComponent",
            "instance_name": "attribute_instance_2",
            "parameters": {"name": "AttributeInstance", "value": 67}
        })
        response = self.client.get("/instance/attribute_instance_2/attribute/value")
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json()["value"], 67)

    def test_set_instance_attribute(self):
        response = self.client.post("/instance/attribute_instance/attribute/value", json={"value": 100})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(instance_registry["attribute_instance"].value, 100)

    def test_batch_update_attributes(self):
        # Create an instance first
        self.client.post("/create-instance/", json={
            "class_name": "TestComponent",
            "instance_name": "test_instance",
        ...
        response = self.client.post("/instance/test_instance/attributes/update/", json={
            "attributes": {
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(instance_registry["test_instance"].name, "UpdatedInstanceName")
        self.assertEqual(instance_registry["test_instance"].value, 100)
    ...
    def test_load_instances_from_yaml_string(self):
        ...
        test_instance_2:
          ...
          parameters:
            ...
            data: "Some data"
        """
        response = self.client.post("/load-instances-from-yaml/", json={"yaml_content": yaml_content})
        self.assertEqual(response.status_code, 200)
    ...
    def test_load_module(self):
        ...
        response = self.client.post("/load-module/", json={"file_path": file_path})
        self.assertEqual(response.status_code, 200)
    ...
    def test_load_modules_from_directory(self):
        ...
        response = self.client.post("/load-modules-from-directory/", json={"directory": test_path})
        self.assertEqual(response.status_code, 200)

    def test_get_classes_by_base_class(self):
        response = self.client.get("/classes-by-base/", params={"base_class_name": "MicroComponent"})
        self.assertEqual(response.status_code, 200)
        self.assertIn("TestComponent", response.json()["classes"])

    def test_get_class_names_by_base_class(self):
        response = self.client.get("/class-names-by-base/", params={"base_class_name": "MicroComponent"})
        self.assertEqual(response.status_code, 200)
...
if __name__ == "__main__":
    ...
    suite.addTest(TestRestApi('test_get_instance_attributes'))
    suite.addTest(TestRestApi('test_get_instance_attribute'))
    suite.addTest(TestRestApi('test_set_instance_attribute'))
    suite.addTest(TestRestApi('test_batch_update_attributes'))
