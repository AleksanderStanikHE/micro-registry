...
class SensorComponent(MicroComponent):
    def __init__(
        self, name: str, parent: Optional[MicroComponent] = None, reading: float = 0.0
    ):
...
class ActuatorComponent(MicroComponent):
    def __init__(
        self, name: str, parent: Optional[MicroComponent] = None, state: bool = False
    ):
        super().__init__(name, parent)
        self._state = state
...
class ControllerComponent(MicroComponent):
    def __init__(
        self, name: str, parent: Optional[MicroComponent] = None, setpoint: float = 0.0
    ):
        super().__init__(name, parent)
